...
vid_name = 'VidExportEmtpyFramesTest4.avi';
...
subtightplot(number_of_frequencies * 3 + 2, number_of_views, [1 number_of_views], [0.0 0.0],0,0);
time_graph(0, fig_bg_color, word_on_time, word_off_time);


subtightplot(number_of_frequencies * 3 + 2, number_of_views, [number_of_views * number_of_frequencies * 3 + number_of_views + 1 number_of_views * number_of_frequencies * 3 + number_of_views + number_of_views], [0.0 0.0],0,0);
time_graph(0, fig_bg_color, word_on_time, word_off_time);
...
%         number_of_views * subplot_num * 3 - number_of_views * 2 + current_view 
%         number_of_views * subplot_num * 3 + current_view
        subtightplot(number_of_frequencies * 3 + 2, number_of_views, [number_of_views * subplot_num * 3 - number_of_views * 2 + current_view number_of_views * subplot_num * 3 + current_view], [0.0 0.0],0,0);
...
%     
%     subtightplot(number_of_frequencies + 2, number_of_views, [1 number_of_views], [0.0 0.0],0,0);
%     time_graph(tNum, fig_bg_color, word_on_time, word_off_time);
% 
%     
%     subtightplot(number_of_frequencies+2, number_of_views, [number_of_views * number_of_frequencies + number_of_views + 1 number_of_views * number_of_frequencies + number_of_views + number_of_views], [0.0 0.0],0,0);
%     time_graph(tNum, fig_bg_color, word_on_time, word_off_time);
% 
%     
%     fprintf("PLOTTING")
...
% %         set(gca,'FontSize',20,'YLim',[-125 100],'ZLim',[-75 100])
%         for current_view = 1: number_of_views
%             subtightplot(number_of_frequencies+2, number_of_views, subplot_num * number_of_views + current_view, [0.0 0.0],0,0);
%             
%             hold on;
%             switch current_view
%                 case 1
